export const baseTopics = [
    {
      ...
      discussionQuestions: [
        ...
        { question: "<a href=\"https://docs.google.com/document/d/16npnBF0hLcaisJUbXREidgq1R8W4vJvE/edit?usp=sharing&ouid=113376576186080604800&rtpof=true&sd=true\" target=\"_blank\">Sample command line quiz questions</a>" },
      ],
      meetings: [
        {
          date: "Tu, Aug 18",
          ...
          description: "This unit introduces the idea of software engineering, including how it is similar and different from programming, and a host of considerations for building software that is scalable and maintainable over time.",
          activities: [
            { title: "Intro to the Course", url: "https://docs.google.com/presentation/d/18NOZfdGIqM70Ar80ltkQITjL8V5upk_z/edit?usp=sharing&ouid=113376576186080604800&rtpof=true&sd=true", draft: 0 },
            { title: "Warm Up", url: "https://docs.google.com/document/d/1rs6sA19DFYhpqCgvhr0Tgeuz05-MaUWx/edit?usp=sharing&ouid=113376576186080604800&rtpof=true&sd=true", draft: 0 },
...

    {
      ...
      discussionQuestions: [
        { question: "<span class=\"badge\">general</span> What does \"shifting left\" mean?" },
        { question: "<span class=\"badge\">testing</span> What are some of the benefits of automated testing?" },
        { question: "<span class=\"badge\">testing</span> What are some of the limits of automated testing?" },
        { question: "<span class=\"badge\">testing</span> What are the different test \"sizes\"? Why are these distinctions important?" },
        { question: "<span class=\"badge\">testing</span> What is meant by \"nondeterminism\" in testing?" },
        { question: "<span class=\"badge\">testing</span> What are some important qualities of a testing suite?" },
        { question: "<span class=\"badge\">testing</span> What are some considerations that go into writing testable code?" },
        { question: "<span class=\"badge\">testing</span> What is the difference between an interpreted and a compiled language?" },
        { question: "<span class=\"badge\">static analysis</span> What languages are interpreted? What languages are compiled?" },
        { question: "<span class=\"badge\">static analysis</span> What do we mean by \"static\"?" },
        { question: "<span class=\"badge\">static analysis</span> What are some examples of static analysis tools?" },
        { question: "<span class=\"badge\">static analysis</span> What are some of the benefits of doing static analysis?" },
        { question: "<span class=\"badge\">static analysis</span> What are some of the challenges / limitations of static analysis?" },
        { question: "<span class=\"badge\">CI</span> What is continuous integration?" },
        { question: "<span class=\"badge\">CI</span> What are some of the key benefits and headaches (i.e. tradeoffs) of continuous integration?" },
        { question: "<span class=\"badge\">CI</span> Can you still use CI if you're working on a really big feature that’s not ready for prime time?" },
        { question: "<span class=\"badge\">CI</span> What happens in the \"presubmit\" phase?" },
        { question: "<span class=\"badge\">CI</span> What is release candidate testing? How is it similar / different from the \"presubmit\" phase?" },
      ],
      meetings: [
        {
          date: "Tu, Sep 22",
          ...
          description: "Continuous integration (CI), static analysis, and testing are complementary software development techniques that ensure that teams can deploy software continuously with a high degree of confidence in the quality of their code. In this unit, we will learn about ways you and your team can automate code testing and validation procedures before merging code updates into the main branch. By setting up a few tools up front, you will save time and energy and increase the reliability of your code base.",
          activities: [
            { title: "Intro to Testing", url: "https://docs.google.com/presentation/d/18UuZZ-d-7g_s8hWD0Qa64qBu705SJehp/edit?usp=sharing&ouid=113376576186080604800&rtpof=true&sd=true", draft: 0 },
          ],
          readings: [
        ...
        {
          date: "Th, Sep 24",
          topic: "Testing Lab: Rock, Paper, Scissors",
        },
        {
          date: "Tu, Sep 29",
