...
The [programming readiness diagnostic](/resources/programming-readiness-diagnostic), module practice, and self-checks are **formative**. They identify what to practice; they do not bank an official Satisfactory result.
...
1. [Java methods and conditionals](/resources/readiness-01-tracing)
2. [Loops, counters, and accumulators](/resources/readiness-02-methods-control-flow)
3. [Lists/arrays and traversal](/resources/readiness-03-lists-arrays)
4. [Maps/sets and frequency counting](/resources/readiness-04-maps-sets)
5. [Simple algorithms and edge cases](/resources/readiness-05-testing)
6. [Testing and debugging](/resources/readiness-06-debugging)
